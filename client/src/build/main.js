...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (myModule) {
		myModule.directive('deployRecord', [function factory() {
			var directive = {
				restrict: 'E', // 指令的使用方式，包括标签，属性，类，注释
				replace: 'true',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (myModule) {
		myModule.factory('DeployService', ['Restangular', '$timeout', function (Restangular, $timeout) {
			var baseRoute = Restangular.all('deploys');
			return {
				list: function list(query) {
					return baseRoute.customGET('', query);
				},
				getOne: function getOne(deployId) {
					return baseRoute.one(deployId).customGET();
				},
				getConfig: function getConfig() {
					return baseRoute.customGET('config');
				},
				run: function run(deployId) {
					return baseRoute.one(deployId, 'run').customPUT();
				},
				remove: function remove(deployId) {
					return baseRoute.one(deployId).remove();
				},
				create: function create(article) {
					return baseRoute.customPOST(article);
				},
				update: function update(deployId, article) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (myModule) {
	    myModule.service('deployRead', ['$modalService', '$q', function factory($modalService, $q) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (app) {
		app.controller('SigninController', ['$scope', '$rootScope', '$http', '$state', 'toasty', function ($scope, $rootScope, $http, $state, toasty) {
			$scope.login = function () {
				$http({
					method: 'post',
					url: "/api/sign/login",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (app) {
		app.controller('SignupController', ['$scope', '$rootScope', '$http', '$state', 'toasty', function ($scope, $rootScope, $http, $state, toasty) {
			$scope.create = function () {
				$http({
					method: 'post',
					url: "/api/sign/reg",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (app) {
		app.controller('DeployController', ['$scope', '$state', '$stateParams', 'DeployService', 'toasty', 'isAdd', 'constant', function ($scope, $state, $stateParams, DeployService, toasty, isAdd, constant) {
			var tagId = $stateParams._id;
			var now = new Date();
			now.setHours(22);
			now.setMinutes(0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (app) {
		app.controller('DeployListController', ['$scope', '$state', '$stateParams', 'DeployService', 'constant', 'toasty', 'deployRead', function ($scope, $state, $stateParams, DeployService, constant, toasty, deployRead) {
			$scope.query = {
				page: $stateParams.page
			};
			$scope.list = function (_query) {
